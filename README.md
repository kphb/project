...
---
### 기능구현
먼저 시연 영상을 통해 간략한 설명과 함께 기능이 동작하는 전체적인 흐름을 보여드리겠습니다.<br>
...
<br><br>
#### - 새로운 글 new 띄우기
Date클래스와 JSTL fmt 태그를 이용해서 오늘날짜와 작성일자가 일치하면 new아이콘이 생성됩니다.<br>
![image](https://user-images.githubusercontent.com/75934431/110604016-f80e5d80-81ca-11eb-9c81-b2c24fb0b86d.png)
<br><br>
#### - 조회수 증가
...
![image](https://user-images.githubusercontent.com/75934431/110605478-87684080-81cc-11eb-88f6-4e0349ed7ce1.png)
<br><br>
#### - 삭제 게시글 복원
게시글을 삭제하면 데이터가 지워지는게 아니라 따로 컬럼을 만들어서 복원이 가능하도록 했습니다.
삭제된 게시글은 '삭제 게시글'메뉴로 이동하고 해당 페이지에서 복원/완전한 데이터삭제가 가능합니다.
![image](https://user-images.githubusercontent.com/75934431/110605662-ae267700-81cc-11eb-8786-68b9e70de86f.png)
<br><br>
#### - 페이지 유지
...
<br><br>
#### - 정렬&검색
정렬은 최신순/조회수 높은 순/추천수 높은 순으로, 검색조건은 제목/내용/제목+내용/지역으로 조회가 가능하고 지역은 select option을 사용해서 선택할 수 있도록 했습니다. 정렬&검색도 UriComponents를 사용해서 uri를 생성하였습니다.<br>
![image](https://user-images.githubusercontent.com/75934431/110607778-e929aa00-81ce-11eb-873a-052268041878.png)
<br><br>
#### - uri복사/공유
![image](https://user-images.githubusercontent.com/75934431/110609173-4d00a280-81d0-11eb-9dfb-45bab778aa32.png)
 <br><br>
#### - 추천
...
![image](https://user-images.githubusercontent.com/75934431/110610807-eed4bf00-81d1-11eb-83c3-9edfa617e60c.png)
<br><br>
#### - 회원가입/로그인
입력한 아이디와 기존 데이터를 비교해서 중복이 있는지 확인하고 비밀번호는 PasswordEncoder클래스의 encode메소드를 이용해서 암호화합니다.
<br><br>
#### - 비밀번호 찾기
...
<br><br>
#### - 답글달기
컬럼에 그룹번호(부모값. 원글일 경우 본인값), 그룹내의 순서(자식값), 깊이(답글의 답글일수록 번호가 커짐)을 추가해서 원글에 답글을 달 수 있도록 했습니다.
![image](https://user-images.githubusercontent.com/75934431/110613022-1f1d5d00-81d4-11eb-98d7-b7389f09c4be.png)
